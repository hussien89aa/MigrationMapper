...
public class TestClient {
	...
	public static void main(String[] args) {
		...
		for (MigrationRule migrationRule : migrationRules) {
			...
			/*
			 * For every migrations, retrieve list of collected of fragments for migration
			 * at method level. every fragment has N added methods M removed methods
			 */
	...
	/*
	 * This method takes list of methods signatures with library that methods belong
	 * to. It will print the signatures and Docs for every method
	 */
	static void printMethodWithDocs(String libraryName, ArrayList<String> listOfMethods) {
		...
		for (String methodSignature : listOfMethods) {
			...
			ArrayList<MethodDocs> toLibrary = new LibraryDocumentationDB().getDocs(libraryName,
