...
//samething for 'removedCode' and 'countRemovedLines'
	...
	public static double getSDegree(ArrayList<Segment> listOfSegment, String inRemovedCode, String inAddedCode) {
		...
		for (Segment segment : listOfSegment) {
			if (segment.addedCode.contains(inAddedCode) && segment.removedCode.contains(inRemovedCode)) {
	...
	public static boolean isFound(ArrayList<Segment> listOfSegment, ArrayList<String> inAddedCode,
			ArrayList<String> inRemovedCode) {
		...
		for (Segment segment : listOfSegment) {
			...
			if (addedFounded == segment.addedCode.size() && removedFounded == segment.removedCode.size()
